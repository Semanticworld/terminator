$(document).ready(function () {
    ...
    Terminator.prototype.createSmilesBox = function () {
        ...
        $(".tr-tabs")
            .prepend('<ul class="tr-tab-caption"><li class="active"><img src="' + this.home + 'ico/0.png"></li><li><img src="' + this.home + 'ico/1.png"></li><li>2</li><li>3</li><li><img src="' + this.home + 'ico/4.png"></li><li><img src="' + this.home + 'ico/5.png"></li><li><img src="' + this.home + 'ico/1.png"></li><li>7</li><li>8</li></ul>');
        $('.tr-window').tr_drags({
            handle: ".tr-title"
        });
