$(document).ready(function () {
    ...
    Terminator.prototype.createSmilesBox = function () {
        ...
        s += '<div class="tr-pt10"><select id="tr-ch21" class="tr-w50"><option value="1">Стиль 1</option><option value="2">Стиль 2</option><option value="3">Стиль 3</option></select><label class="tr-pl10" for="tr-ch21">Дизайн страницы</label></div>';
