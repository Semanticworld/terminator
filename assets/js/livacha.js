$(document).ready(function () {
    ...
    Terminator.prototype.createSmilesBox = function () {
        ...
        s += '<div class="tr-pt10"><input value="' + getMemoryValue("anticaps") + '"  data-cmd="anticaps" type="checkbox" class="ios8-switch tr-config" id="tr-ch20" checked><label for="tr-ch20">Антикапс</label></div>';
        s += '<div class="tr-pt10"><input value="' + getMemoryValue("antimat") + '"  data-cmd="antimat" type="checkbox" class="ios8-switch tr-config" id="tr-ch21" checked><label for="tr-ch21">Антимат</label></div>';
