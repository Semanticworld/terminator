$(document).ready(function () {
    ...
    Terminator.prototype.createSmilesBox = function () {
        ...
        s = '<div class="tr-pt10"><input value="0" data-cmd="snow" type="checkbox" class="ios8-switch tr-config" id="tr-ch1"><label for="tr-ch1">Падающие эффекты</label></div>';
        s += '<div class="tr-pt10"><input value="0"  data-cmd="sound" type="checkbox" class="ios8-switch tr-config" id="tr-ch2" checked><label for="tr-ch2">Звуковые эффекты</label></div>';
        s += '<div class="tr-pt10"><input value="0"  data-cmd="sound" type="checkbox" class="ios8-switch tr-config" id="tr-ch3" checked><label for="tr-ch3">Отключить звуковые эффекты</label></div>';
        s += '<div class="tr-pt10"><input value="0"  data-cmd="sound" type="checkbox" class="ios8-switch tr-config" id="tr-ch4" checked><label for="tr-ch4">Отключить звуковые эффекты</label></div>';
        s += '<div class="tr-pt10"><input value="0"  data-cmd="anticaps" type="checkbox" class="ios8-switch tr-config" id="tr-ch20" checked><label for="tr-ch20">Антикапс</label></div>';
        s += '<div class="tr-pt10"><input value="0"  data-cmd="antimat" type="checkbox" class="ios8-switch tr-config" id="tr-ch21" checked><label for="tr-ch21">Антимат</label></div>';
