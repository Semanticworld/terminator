$(document).ready(function () {
    ...
    Terminator.prototype.createSmilesBox = function () {
        ...
        s += '<div class="tr-pt10"><input data-cmd="anticaps" type="checkbox" class="ios8-switch" id="tr-ch3" checked><label for="tr-ch3">Антикапс</label></div>';
        s += '<div class="tr-pt10"><input data-cmd="antimat" type="checkbox" class="ios8-switch" id="tr-ch4" checked><label for="tr-ch4">Антимат</label></div>';
